...
(
    ...
    total_consumos NUMERIC(10, 2) NOT NULL CHECK (total_consumos >= 0),
    total_servicos NUMERIC(10, 2) NOT NULL CHECK (total_servicos >= 0),
    percentual_desconto NUMERIC(10, 2) DEFAULT 0.0,
